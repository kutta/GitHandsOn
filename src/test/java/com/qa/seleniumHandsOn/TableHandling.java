package com.qa.seleniumHandsOn;
...
public class TableHandling {
	...
	final static Logger Log = Logger.getLogger(TableHandling.class.getName());
	...
	public void dynamicTable() throws ParseException{
		try {
			...
			Log.info("Browser Refresh instantiated");
